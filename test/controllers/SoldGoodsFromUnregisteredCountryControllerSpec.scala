...
class SoldGoodsFromUnregisteredCountryControllerSpec extends SpecBase with MockitoSugar {

  private val formProvider = new SoldGoodsFromUnregisteredCountryFormProvider()
  private val form = formProvider()

  private lazy val soldGoodsRoute = routes.SoldGoodsFromUnregisteredCountryController.onPageLoad(period).url

  "SoldGoodsFromUnregisteredCountry Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val view = application.injector.instanceOf[SoldGoodsFromUnregisteredCountryView]
