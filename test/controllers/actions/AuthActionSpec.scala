    ...
    "when the user is logged in as an Organisation Admin with a VAT enrolment and strong credentials" - {
      ...
      "must succeed" in {
        ...
        running(application) {
          ...
          val authAction = new IdentifierAction(mockAuthConnector, mockAuditService, mockRegistrationConnector, appConfig)
    ...
    "when the user is logged in as an Individual with a VAT enrolment, strong credentials and confidence level 200" - {
      ...
      "must succeed" in {
        ...
        running(application) {
          ...
          val action = new IdentifierAction(mockAuthConnector, mockAuditService, mockRegistrationConnector, appConfig)
